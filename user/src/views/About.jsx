      ...
      <div className='flex flex-col'>
        ...
        <div className='flex-1 pt-2 flex flex-col md:flex-row gap-4 items-center justify-center md:text-lg h-fit'>
          ...
          <div className='flex-1 rounded-lg overflow-hidden m-3'>
            ...
            <img src="https://i.pinimg.com/564x/b8/d1/15/b8d115fc6596fa886f5a6ecea56e28e8.jpg" alt="" className='object-cover w-full' />
