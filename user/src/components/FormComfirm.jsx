...
const FormComfirm = (props) => {
    ...
    return (
    <div className='w-screen h-full z-[1] flex absolute top-0 left-0 bg-black bg-opacity-60' onClick={e => props.toggle(null)}>
        <form className='bg-white relative w-5/6 md:w-1/2 h-fit m-auto p-5 rounded-xl' onClick={e => e.stopPropagation()} onSubmit={handleSubmit}>
            ...
            <div className='m-4'>
                ...
                <div className='flex m-4'>
                    ...
                    <div className='flex-1 flex items-center'>
                        <label htmlFor=""><i class="ri-mail-line mx-2"></i></label>
            ...
            <div className='flex px-5'>
                <button disabled={check} className='bg-blue-500 m-auto w-full rounded-full p-2 text-white hover:bg-blue-700'>Xác nhận</button>
            </div>
        </form>
    </div>
  )
