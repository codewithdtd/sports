...
function Navbar() {
  ...
  const user = useSelector((state) => state.user.login.user.user)
        ...
        <ul className="navigation__link text-gray-300">
          {user?.chuc_vu == 'admin' &&
            <li className="navigation__link__items">
              <NavLink onClick={toggleMenu} className={({ isActive }) => `${isActive ? " bg-blue-500 text-white" : ""} p-1 py-2 block m-2 rounded-md hover:text-white hover:bg-blue-500 mx-3 font-medium`} to="/">
          ...
          {user?.chuc_vu == 'admin' &&
            <>
              <li className="navigation__link__items">
                <NavLink onClick={toggleMenu} className={({ isActive }) => `${isActive ? "bg-blue-500 text-white" : ""} p-1 py-2 block m-2 rounded-md hover:text-white hover:bg-blue-500 mx-3 font-medium`} to="/sportType" end>
                  <i className="ml-5 ri-bubble-chart-fill mr-2"></i>
                  <span>Phân loại sân</span>
                </NavLink>
              </li>
              <li className="navigation__link__items">
                <NavLink onClick={toggleMenu} className={({ isActive }) => `${isActive ? "bg-blue-500 text-white" : ""} p-1 py-2 block m-2 rounded-md hover:text-white hover:bg-blue-500 mx-3 font-medium`} to="/facilityManagement" end>
          ...
          <li className="navigation__link__items">
            <NavLink onClick={toggleMenu} to="/booking" className={({ isActive }) => `${isActive ? "bg-blue-500 text-white" : ""} p-1 py-2 block m-2 rounded-md hover:text-white hover:bg-blue-500 mx-3 font-medium`}>
              <i className="ml-5 ri-time-line mr-2"></i>
              <span>Đặt sân</span>
            </NavLink>
          </li>
          <li className="navigation__link__items">
            <NavLink onClick={toggleMenu} className={({ isActive }) => `${isActive ? "bg-blue-500 text-white" : ""} p-1 py-2 block m-2 rounded-md hover:text-white hover:bg-blue-500 mx-3 font-medium`} to="/invoice">
          ...
          <li className="navigation__link__items">
            <NavLink onClick={toggleMenu} to="/review" className={({ isActive }) => `${isActive ? "bg-blue-500 text-white" : ""} p-1 py-2 block m-2 rounded-md hover:text-white hover:bg-blue-500 mx-3 font-medium`}>
              <i className="ml-5 ri-feedback-line mr-2"></i>
              <span>Đánh giá</span>
            </NavLink>
          </li>
          <li className="navigation__link__items">
            <NavLink onClick={toggleMenu} to="/contact" className={({ isActive }) => `${isActive ? "bg-blue-500 text-white" : ""} p-1 py-2 block m-2 rounded-md hover:text-white hover:bg-blue-500 mx-3 font-medium`}>
              <i className="ml-5 ri-feedback-line mr-2"></i>
              <span>Liên hệ</span>
            </NavLink>
          </li>
          ...
          {/* <li className="navigation__link__items">
                ...
                <li className="navigation__link__items">
                    <NavLink onClick={toggleMenu} to="/userMembership" className={({ isActive }) => `${isActive ? "bg-blue-500 text-white" : ""} p-1 py-2 block m-2 rounded-md hover:text-white hover:bg-blue-500 mx-3 font-medium`}>
                        <i className="ml-5 ri-shield-user-fill mr-2"></i> 
                        <span>Hội viên</span>
                    </NavLink>
                </li> */}
          {/* <li className="navigation__link__items">
                    <NavLink onClick={toggleMenu} to="/event" className={({ isActive }) => `${isActive ? "bg-blue-500 text-white" : ""} p-1 py-2 block m-2 rounded-md hover:text-white hover:bg-blue-500 mx-3 font-medium`}>
