    ...
    <div className="header py-1 bg-white mb-2 rounded-xl px-2 items-center pl-12 md:pl-0 flex justify-between" onClick={e => getNotify()}>
      ...
      <div className="header__right flex items-center">
        <div className='hover:bg-gray-200 relative group mr-2 p-1 px-2 aspect-square rounded-full'>
          ...
          <div className='absolute notify hidden group-hover:block px-2 top-[95%] right-0 min-w-72 max-w-1/2 bg-white shadow-lg shadow-gray-400 rounded-md overflow-y-scroll max-h-64 z-[2]'>
        ...
        <div className='group relative flex min-w-52'>
          <div className='flex items-center'>
            ...
            <div className='ml-2 hidden sm:block'>
              ...
              <p className='text-sm font-medium text-gray-600'>Chức vụ: {user?.user.chuc_vu}</p>
            </div>
          </div>
